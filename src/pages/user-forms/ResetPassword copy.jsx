...
const ResetPassword = () => {
  ...
  const { kyb_admin_panel, login, logout } = useContext(AuthContext);
  ...
  const onSubmit = async (e) => {
    ...
    if (err) {
      ...
      try {
        ...
        formData.append("tempPassword", kyb_admin_panel.password);
        formData.append("newPassword", newPassword);
        formData.append("confirmNewPassword", confirmPassword);
        formData.append("tempToken", kyb_admin_panel.temp_token);
        // let token = await RefreshToken(kyb_admin_panel.access_token)
        let token = kyb_admin_panel.access_token;
